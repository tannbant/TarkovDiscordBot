...
6. Then setup the .env with the discord bot token in the developer portal website of discord. After go to the text channel where bot will send, then right click the channel and copy the ID. 
